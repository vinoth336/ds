...
class TablesController extends Controller 
{
   	...
   	public function getIndex()
	{
		...
		return view('abserve.tables.index',$this->data);
    ...
    public function getTableconfig( $table = null )
    {
        ...
        $this->data['action'] = ($table ==null ? 'abserve/tables/tables/'.$table : 'abserve/tables/tableinfo/'.$table ) ;
        return view('abserve.tables.config',$this->data);
        // return Redirect::to('dashboard');
    }   
    ...
    public function postTableremove(Request $request)
    {
        ...
        if(!is_null($request->input('id')) && count($request->input('id')) >=1 )
        {
            ...
            return Redirect::to('abserve/tables')->with('messagetext', 'Table(s) has been deleted')->with('msgstatus','success');  
        } 
        return Redirect::to('abserve/tables')->with('messagetext','error','No Table(s) deleted !')->with('msgstatus','error');  
    ...
    public function getTablefieldedit( $table )
    {
        ...
        return view('abserve.tables.field',$this->data);
    }
    ...
    public function getMysqleditor()
    {
        ...
        return view('abserve.tables.editor');
        // return Redirect::to('dashboard');
    }   
