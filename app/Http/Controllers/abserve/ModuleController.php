...
use App\Models\Abserve\Module;
use App\Library\ZipHelpers;
use App\Library\AbserveHelpers;
...
class ModuleController extends Controller {
	...
	public function getIndex( Request $request)
	{
		...
		return view('abserve.module.index',$this->data);
    ...
    function getCreate()
    {
        ...
        return view('abserve.module.create',$this->data);
        // return Redirect::to('dashboard');       
    ...
    function postCreate( Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if($request->input('creation') == 'manual')
            {
                if($where =="")                
                {
                    return Redirect::to('abserve/module/create')                    
        ...
        //    echo '<pre>'; print_r($columns); echo '</pre>';    exit;
            ...
            if(count($row) >= 1)
            {
                ...
                return Redirect::to('abserve/module/rebuild/'.$id->module_id);  
                // return Redirect::to('dashboard');      
            } else {
                return Redirect::to('abserve/module');
            }
    ...
    function getDestroy( $id = null )
    {
        $row = \DB::table('tb_module')->where('module_id', $id)
                                ->get();        
        if(count($row) <= 0){
            return Redirect::to('abserve/module')->with('messagetext','Can not find module')->with('msgstatus','error');   
    ...
    function getConfig( $id )
    {
		...
		return view('abserve.module.config',$this->data);        
    ...
    function postSaveconfig( Request $request) 
    {
        ...
        if ($validator->passes()) {
            ...
            return Redirect::to('abserve/module/config/'.$request->input('module_name'))
    ...
    function getSql(Request $request , $id )
    {
		...
		$this->data['module_name'] 		= $row->module_name;    
		$this->data['module'] 			= 'module';
		return view('abserve.module.sql',$this->data);
    ...
    function postSavesql( Request $request ,$id )
    {
        ...
        try {   
           // \DB::select( $select .' '.$where.' '.$group );            
            ...
            // Do something when query fails. 
            $error ='Error : '.$select .' '.$where.' '.$group ;
            return Redirect::to('abserve/module/sql/'.$request->input('module_name'))
            ->with('messagetext', $error)->with('msgstatus','error');   
        }
        //echo $select .' '.$where.' '.$group; exit;
        $row = \DB::table('tb_module')->where('module_name', $id)
                                ->get();
        if(count($row) <= 0){
            return Redirect::to($this->module)
       ...
       \DB::table('tb_module')
        ...
        return Redirect::to('abserve/module/sql/'.$row->module_name)
    ...
    function getTable( $id )
    {
		...
		"option" => array (
						"opt_type" => 'datalist', 
						"lookup_query" => '1:Active|0:Inactive', 
						"lookup_table" =>'', 
						"lookup_key" =>'', 
						"lookup_value" =>'', 
						"is_dependency" =>'', 
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('abserve.module.table',$this->data);
    ...
    function getForm( $id )
    {
		...
		$this->data['module'] = 'module';
		$this->data['module_name'] = $row->module_name;
		return view('abserve.module.form',$this->data);
    ...
    public function postSaveform( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('abserve/module/form/'.$row->module_name)
    ...
    public function getEditform(Request $request, $id )
    {
        ...
        $this->data['module'] = 'module';
        $this->data['module_name'] = $row->module_name;
        return view('abserve.module.field',$this->data);
    } 
   ...
   function postSaveformfield( Request $request)
    ...
    public function postSavetable( Request $request)
    {
       ...
       // echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
        ...
        return Redirect::to('abserve/module/table/'.$row->module_name)
   ...
   function getPermission( $id )
    {
            ...
            */   
            ...
            return view('abserve.module.permission',$this->data);
    ...
    public function postSavepermission( Request $request)
    {
        ...
        */         
        ...
        return Redirect::to('abserve/module/permission/'.$row->module_name)
    ...
    function getBuild( $id )
    {
        ...
        return view('abserve.module.build',$this->data);
    ...
    function getFormdesign( Request $request , $id)
    {
        ...
        $this->data['module_name'] = $row->module_name;
        return view('abserve.module.formdesign',$this->data);    
    }   
    ...
    //    echo '<pre>'; print_r($f); echo '</pre>';    exit;
     ...
     //  echo '<pre>'; print_r($new_config); echo '</pre>';    exit;
      \DB::table('tb_module')
        ...
        return Redirect::to('abserve/module/formdesign/'.$row->module_name)
    ...
    function getSub( Request $request, $id ='')
    {
		...
		return view('abserve.module.sub',$this->data);    
    ...
    function postSavesub( Request $request)
    {
        ...
        if ($validator->passes()) {                
          ...
          //  echo '<pre>'; print_r($new_config); echo '</pre>'; exit;
            ...
            return Redirect::to('abserve/module/sub/'.$row->module_name)
            ->with('messagetext','Master Has beed added Successful.')->with('msgstatus','success');  

        }    else {

            return Redirect::to('abserve/module/sub/'.$request->get('module_name'))
    ...
    function getConn( Request $request , $id )
    {
        ...
        return view('abserve.module.connection',$this->data);
    }   
   ...
   function configGrid ( $field , $alias , $type, $sort ) {
    ...
    function postDobuild( Request $request ,$id )
    {
        ...
        //return redirect('')
        $url = 'abserve/module/rebuild/'.$id."?rebuild=y&c={$c}&m={$m}&g={$g}&f={$f}&v={$v}";
    ...
    public function getRebuild(Request $request, $id = 0)
    {
            ...
            if($row->module_type =='generic')
            {
                ...
                $template = base_path().'/resources/views/abserve/module/template/blank/';
            ...
            {
                $template   = base_path().'/resources/views/abserve/module/template/report/';
                $controller = file_get_contents( $template.'controller.tpl' );
                $grid       = file_get_contents(  $template.'grid.tpl' );
                $model       = file_get_contents(  $template.'model.tpl' );  
            ...
            if($row->module_type =='addon')
            {
                ...
                $template = base_path().'/resources/views/abserve/module/template/native/';
                $controller = file_get_contents(  $template.'controller.tpl' );
                $grid = file_get_contents(  $template.'grid.tpl' );               
                $view = file_get_contents(  $template.'view.tpl' );
                $form = file_get_contents(  $template.'form.tpl' );
            ...
            return Redirect::to('abserve/module')->with('messagetext','Code Script has been replaced successfull')->with('msgstatus','success');   
    ...
    function postPackage( Request $request) 
    {
        ...
        return view('abserve.module.package',$this->data);  
        // return Redirect::to('dashboard');
  ...
  function postInstall( Request $request ,$id =0)
  {
    ...
    if ($validator->passes()) {
      ...
      $data = \AbserveHelpers::cf_unpackage($path);
      ...
      self::createRouters();
          ...
          return Redirect::to('abserve/module')->with('messagetext','Module Installed' . $msg)->with('msgstatus','success');
    }  else  {
         return Redirect::to('abserve/module')->with('messagetext','Please select file to upload !')->with('msgstatus','error');
    } 
