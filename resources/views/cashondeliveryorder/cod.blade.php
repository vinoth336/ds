  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Cash on delivery Orders</li>
      </ul>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'cashondeliveryorder/codview?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset>
                        <legend> Cash on delivery Orders</legend>
		...
		$('#view').click(function(){
		 ...
		 if(id == ''){
		  ...
		  $(".display-error2").hide();	 
			 ...
			 if(id != ''){
			$.ajax({
					url: '<?php echo url(); ?>/cashondeliveryorder/codview',
					type: "POST",
					data: {id:id},
