 	...
 	<div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'franchiseusers/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
        		<div class="col-md-12">
				...
				<div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('franchiseusers?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
...
$(document).ready(function() {	
	...
	$("#region").jCombo("{{ URL::to('franchiseusers/comboselect?filter=region:id:region_name') }}",
