...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'paymentorder/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> {!! trans('core.abs_paymentorder') !!}</legend>
				           ...
				           >{{ $row['order_details'] }}</textarea> 
								  ...
								  <div class="form-group  " >
									<label for="Through" class=" control-label col-md-4 text-left"> {!! trans('core.abs_through') !!} </label>
									<div class="col-md-6">
									  {!! Form::text('through', $row['through'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									<label for="Amount" class=" control-label col-md-4 text-left"> {!! trans('core.abs_amount') !!} </label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Status" class=" control-label col-md-4 text-left"> {!! trans('core.status') !!} </label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Action" class=" control-label col-md-4 text-left"> {!! trans('cor.btn_action') !!} </label>
									<div class="col-md-6">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('paymentorder?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
