  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('adminusers?return='.$return) }}">{{ $pageTitle }}</a></li>
 	...
 	<div class="page-content-wrapper">
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'adminusers/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
                <div class="col-md-12">
                  <fieldset><legend> Customer Support</legend>
                    ...
                    <div class="form-group hidethis " style="display:none;">
                    	...
                    	<div class="col-md-6">
                            ...
                            <input name="group_id" type="hidden" id="group_id" class="form-control" value="1" />
                     	</div> 
                     	<div class="col-md-2"></div>
                    </div> 					
                    	...
                    	<div class="col-md-6">
                         ...
                         <div class="form-group  " >
                           <?php if(session()->get('gid') == '1'){  ?>
                            <label for="Region Name" class=" control-label col-md-4 text-left"> Region Name</label>
                             <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">	
                    	...
                    	<button type="button" onclick="location.href='{{ URL::to('adminusers?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
                    </div>                
                </div> 
...
$(document).ready(function() { 
	...
	$("#region").jCombo("{{ URL::to('area/comboselect?filter=region:id:region_name') }}",
