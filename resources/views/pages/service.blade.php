                ...
                <div class="col-md-12">
                    <div class="hello_slid">
                      @foreach ($service_banners as $service_banner)
                        <div class="slid_item">
                            <div class="home_text ">
                                <img src="{{ asset('uploads/service_banner/'.$service_banner->service_banner) }}" >
                                <div class="banner-content">
                                
                                    <h1 class="text-white">{{ $service_banner->title }}</h1>
              ...
              <div class="head_title text-center fix">
                ...
                <div class="col-md-12 how-to-book">
                    <div class="features_item sm-m-top-30">
                        ...
                        <div class="img-home">
                            <img src="{{ asset('abserve/assets/images/services/service-mid-ban.jpg') }}" alt="" >
                        </div>
                    </div>
                </div>                            
                              ...
                              @foreach ($service_sliders as $service_slider)
                                <div class="col-sm-2 col-xs-3">
                                    <div class="port_item xs-m-top-30">
                                        <div class="port_img">
                                        	<img src="{{ asset('uploads/service_slider/'.$service_slider->slider_image) }}" >
                                        </div>
                                        <div class="port_caption m-top-20">
                                            <h5>{{ $service_slider->title }}</h5>
                                        </div>
                                    </div>
                                </div>
                                @if ($limit <= $offset)
