...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			...
			@endif	
			<a href="{{ URL::to( 'core/users/search') }}" class="btn btn-sm btn-white" onclick="AbserveModal(this.href,'Advance Search'); return false;" ><i class="text-danger fa fa-search"></i> Search</a>		
		 
		</div> 		

	
	
	 {!! Form::open(array('url'=>'core/users/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#AbserveTable').attr('action','{{ URL::to("core/users/multisearch")}}');
		$('#AbserveTable').submit();
	});
