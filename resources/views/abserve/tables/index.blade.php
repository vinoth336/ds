 	...
 	<div class="page-content-wrapper m-t">
 		...
 		<div class="ajaxLoading"></div>
			...
			<span class="pull-right">	
				<a href="{{ URL::TO('abserve/tables/tableconfig/')}}" class="btn btn-xs btn-primary linkConfig"><i class="fa fa-plus"></i> New Table </a>
				<a href="{{ URL::TO('abserve/tables/mysqleditor/')}}" class="btn btn-xs btn-success linkConfig"><i class="fa fa-pencil"></i> MySQL Editor </a>
			</span>	
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					{!! Form::open(array('url'=>'abserve/tables/tableremove/', 'class'=>'form-horizontal','id'=>'removeTable' )) !!}
						...
						<table class="table table-striped">
							...
							@foreach($tables as $table)
								<tr>
									...
									<td><a href="{{ URL::TO('abserve/tables/tableconfig/'.$table)}}" class="linkConfig" > {{ $table }}</a></td>
									<td>
