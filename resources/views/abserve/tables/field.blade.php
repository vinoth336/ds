{!! Form::open(array('url'=>'abserve/tables/tablefieldsave/'.$table, 'class'=>'form-horizontal','id'=>'columnTable' )) !!}
...
function showResponse(data)  {		
	...
	{
		url = "{{ URL::TO('abserve/tables/tableconfig/'.$table) }}";	
		$.get( url , function( data ) {
			$('#abserve-modal').modal('hide');
