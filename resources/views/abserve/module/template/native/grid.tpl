...
<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			...
			@endif 
			<a href="{{ URL::to( '{class}/search') }}" class="btn btn-sm btn-white" onclick="AbserveModal(this.href,'Advance Search'); return false;" ><i class="fa fa-search"></i> Search</a>				
	 ...
	 {!! Form::open(array('url'=>'{class}/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#AbserveTable').attr('action','{{ URL::to("{class}/multisearch")}}');
		$('#AbserveTable').submit();
	});
