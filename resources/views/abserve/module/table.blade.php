...
@section('content')
  <div class="page-content row">
	...
	@include('abserve.module.tab',array('active'=>'table'))

@if(Session::has('message'))
       {{ Session::get('message') }}
@endif

 {!! Form::open(array('url'=>'abserve/module/savetable/'.$module_name, 'class'=>'form-horizontal')) !!}
<div class="sbox">
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick " title="Lookup Display" 
					onclick="AbserveModal('{{ URL::to('abserve/module/conn/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}' ,' Connect Field : {{ $rows['field']}} ' )"
					>
