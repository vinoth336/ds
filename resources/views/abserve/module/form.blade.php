  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('abserve/module') }}"> Module </a></li>
        <li class="active"> Form Editor </li>
      </ul>		  
	  
    </div>
	<div class="page-content-wrapper m-t"> 
	@include('abserve.module.tab',array('active'=>'form'))
...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li class="active" ><a href="{{ URL::to('abserve/module/form/'.$module_name)}}">Form Configuration </a></li> 
	<li ><a href="{{ URL::to('abserve/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
</ul>
  
<div class="sbox">
	<div class="sbox-title"><h5> Form Grid  </h5></div>
	<div class="sbox-content">	
 {!! Form::open(array('url'=>'abserve/module/saveform/'.$module_name, 'class'=>'form-horizontal')) !!}
 <div class="table-responsive">
	...
	?>
		<select name="required[<?php echo $id;?>]" id="required" class="form-control" style="width:150px;" >
			...
			onclick="AbserveModal('{{ URL::to('abserve/module/editform/'.$row->module_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}','Edit Field : <?php echo $rows['field'];?>')">
