...
<ul class="nav nav-tabs" style="margin-bottom:10px;">
  	<li ><a href="{{ URL::to('abserve/module/form/'.$module_name)}}">Form Configuration </a></li> 
	<li class="active" ><a href="{{ URL::to('abserve/module/formdesign/'.$module_name)}}">Form Layout</a></li> 
</ul>
...
<div class="sbox">
 ...
 {!! Form::open(array('url'=>'abserve/module/formdesign/'.$module_name,'id'=>'doReorder', 'class'=>'form-vertical','parsley-validate'=>'','novalidate'=>' ')) !!}
