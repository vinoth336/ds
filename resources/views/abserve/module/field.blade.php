...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("{{ URL::to('abserve/module/combotable') }}" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("{{ URL::to('abserve/module/combotablefield') }}?table=",
 ...
 {!! Form::open(array('url'=>'abserve/module/saveformfield/'.$module_name, 'class'=>'form-horizontal')) !!}
