...
@section('content')
  ...
  <div class="page-content row">
	...
	@include('abserve.module.tab',array('active'=>'sub'))
...
<div class="sbox">
  ...
  @if(count($subs) < 1)
    {!! Form::open(array('url'=>'abserve/module/savesub/'.$module_name, 'class'=>'form-horizontal  ')) !!}
 ...
 @endif
    ...
    <tbody class="no-border-x no-border-y"> 
      ...
      <tr>
        ...
        onclick="AbserveConfirmDelete('{{ URL::to('abserve/module/removesub?id='.$row->module_id.'&mod='.$rows['module']) }}');" 
...
$(document).ready(function(){   
    $("#table").jCombo("{{ url('abserve/module/combotable') }}",
    { }); 
    $("#key").jCombo("{{ url('abserve/module/combotablefield') }}?table=",
    { parent  :  "#table"}); 
});
</script> 
