...
@section('content')
  ...
  <div class="panel-default panel">
    ...
    <ul class="parsley-error-list">
     ...
     {!! Form::open(array('url'=>'abserve/module/dopackage', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
          <div class="col-md-6">
              <div class="header" >
          ...
          <div class="col-md-6">
           ...
           <p> Zip Package is a tool for backup  your module as installer . <br /> 
		   	You can backup current module and install the modules to other application based Abserve builder - Edition Laravel </p>
		   </p> 
