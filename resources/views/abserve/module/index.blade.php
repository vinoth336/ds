...
<div class="page-content row">
		...
		<section >
				...
				<div class="row m-l-none m-r-none m-t  white-bg shortcut " >
					<div class="col-sm-3 b-r  p-sm ">
						...
						<a href="{{ URL::to('abserve/module/create') }}" class="clear">
					...
					<div class="col-sm-3 b-r  p-sm">
						...
						<a href="{{ URL::to('abserve/module/package') }}" class="clear post_url">
	...
	@endif	
      <div class="white-bg p-sm m-b unziped" style=" border:solid 1px #ddd; display:none;">
	   {!! Form::open(array('url'=>'abserve/module/install/', 'class'=>'breadcrumb-search','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
 	...
 	<ul class="nav nav-tabs" style="margin-bottom:10px;">
	  <li @if($type =='addon') class="active" @endif><a href="{{ URL::to('abserve/module')}}"> {!! Lang::get('core.tab_installed') !!}  </a></li>
	  <li @if($type =='core') class="active" @endif><a href="{{ URL::to('abserve/module?t=core')}}">{!! Lang::get('core.tab_core') !!}</a></li>
	</ul>     
	...
	@endif
	 {!! Form::open(array('url'=>'abserve/module/package#', 'class'=>'form-horizontal' ,'ID' =>'AbserveTable' )) !!}
			...
			<tr>		
				...
				<I class="icon-cogs"></I> <span class="caret"></span>
					...
					<ul style="display: none;" class="dropdown-menu icons-right">
						...
						@endif
						<li><a href="{{ URL::to('abserve/module/config/'.$row->module_name)}}"><i class="icon-pencil3"></i> {!! Lang::get('core.btn_edit') !!}</a></li>						
						@if($type != 'core')
						<li><a href="javascript://ajax" onclick="AbserveConfirmDelete('{{ URL::to('abserve/module/destroy/'.$row->module_id)}}')"><i class="icon-bubble-trash"></i> {!! Lang::get('core.btn_remove') !!}</a></li>
						<li class="divider"></li>
						<li><a href="{{ URL::to('abserve/module/rebuild/'.$row->module_id)}}"><i class="icon-spinner7"></i> Rebuild All Codes</a></li>
						@endif
					</ul>
				</div>					
				</td>
	...
	@else
		...
		<br /><br />
		<a href="{{ URL::to('abserve/module/create')}}" class="btn btn-default "><i class="icon-plus-circle2"></i> New module </a>
		 </p>	
	@endif
	</div>	
	{!! Form::close() !!}
