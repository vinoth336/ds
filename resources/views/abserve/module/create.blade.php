...
@section('content')
  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('abserve/module') }}">{!! Lang::get('core.t_module') !!}</a></li>
 ...
 {!! Form::open(array('url'=>'abserve/module/create/', 'class'=>'form-horizontal', 'parsley-validate'=>'','novalidate'=>'')) !!}
