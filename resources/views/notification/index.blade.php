  ...
  <div class="page-content row">
	...
	<div class="page-content-wrapper m-t">	 
	    <div class="toolbar-line ">
			...
			<a href="javascript://ajax"  onclick="AbserveDelete();" class="tips btn btn-sm btn-danger pull-right" title="{!! Lang::get('core.btn_remove') !!}">
		 ...
		 {!! Form::open(array('url'=>'notification/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}	
