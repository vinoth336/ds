...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('lbstudleaves/update') }}" class="tips btn btn-sm btn-white"  title="{!! Lang::get('core.btn_create') !!}">
			...
			@endif 
			<!--<a href="{{ URL::to( 'lbstudleaves/search') }}" class="btn btn-sm btn-white" onclick="AbserveModal(this.href,'Advance Search'); return false;" ><i class="fa fa-search"></i> Search</a>				
			@if($access['is_excel'] ==1)
			<a href="{{ URL::to('lbstudleaves/download?return='.$return) }}" class="tips btn btn-sm btn-white" title="{!! Lang::get('core.btn_download') !!}">
	 ...
	 {!! Form::open(array('url'=>'lbstudleaves/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#AbserveTable').attr('action','{{ URL::to("lbstudleaves/multisearch")}}');
		$('#AbserveTable').submit();
	});
	...
	$('.datatable').DataTable({
        ...
        ajax: '{{ URL::to("lbstudleaves/lbstudleaves")}}',
		dom: 'Blfrtip',
    	buttons: {
			buttons: [
        ...
        columns: [
            ...
            {data: 'id', name: 'id'},
			{data: 'stud_name', name: 'lunch_box_student_info.stud_name'},
