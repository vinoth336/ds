    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ url()}}">
         <img src="{{ asset('abserve/themes/abserve/img/logo-invert.png') }}" alt="Image Alternative text" title="Image Title" />
        </a>
      </div>
           ...
           <ul class="nav navbar-nav navbar-right">
            ...
            @if(!Auth::check()) 
             ...
             @else
                ...
                <img class="origin round user_image" src="{{$user_image_path}}" alt="Image Alternative text" title="@if($username != ''){{$username}}@else{{$first_name}}@endif" />@if($username != ''){{$username}}@else{{$first_name}}@endif</a></li>
        ...
        <footer id="main-footer">
            <div class="container">
                <div class="row row-wrap">
                    <?php $blocks = DB::select("SELECT * FROM `blocks` ");
