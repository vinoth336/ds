...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'servicemaincategories/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Service Main Categories</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  <input  type='file' name='cat_icon' id='cat_icon' @if($row['cat_icon'] =='') class='required' @endif style='width:150px !important;'  />
					 	<div >
									  {!! SiteHelpers::showUploadedFile($row['cat_icon'],'/uploads/service_cat_icon/') !!}
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('servicemaincategories?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
