...
<!--<div class="sbox-tools" >
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('lbstudent/update') }}" class="tips btn btn-sm btn-white"  title="{!! Lang::get('core.btn_create') !!}">
			...
			@endif 
			<!--<a href="{{ URL::to( 'lbstudent/search') }}" class="btn btn-sm btn-white" onclick="AbserveModal(this.href,'Advance Search'); return false;" ><i class="fa fa-search"></i> Search</a>				
			@if($access['is_excel'] ==1)
			<a href="{{ URL::to('lbstudent/download?return='.$return) }}" class="tips btn btn-sm btn-white" title="{!! Lang::get('core.btn_download') !!}">
	 ...
	 {!! Form::open(array('url'=>'lbstudent/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}
            ...
            <table class="table table-hover table-bordered table-striped datatable" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th width="3%">Primary Number</th>
                        <th width="3%">Secondary Number</th>
                        <th width="4%">Student Name</th>
                        <th width="4%">School Name</th>
                        <th width="4%">Pickup Address</th>
                        <th width="4%">Pickup Time</th>
                        <th width="9%">Return Time</th>
                        <th width="9%">Subscription Plan</th>
                        <th width="9%">Plan From</th>
                        <th width="9%">Plan To</th>
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#AbserveTable').attr('action','{{ URL::to("lbstudent/multisearch")}}');
		$('#AbserveTable').submit();
	});
	...
	$('.datatable').DataTable({
        ...
        ajax: '{{ URL::to("lbstudent/lbstudent")}}',
		dom: 'Blfrtip',
    	buttons: {
			buttons: [
        ...
        columns: [
            ...
            {data: 'primary_number', name: 'lunch_box_customers.primary_number'},
            {data: 'secondary_number', name: 'lunch_box_customers.secondary_number'},
            {data: 'stud_name', name: 'stud_name'},
            {data: 'school_name', name: 'delivery_point.name'},
