...
$(document).ready(function(){
	...
	$('.datatable').DataTable({
        ...
        ajax: '{{ URL::to("foodsubcategories/foodsubcategories")}}',
		dom: 'Blfrtip',
    	buttons: {
			buttons: [
				{ extend: 'excel', text: '<i class="fa fa-download"></i> Download', titleAttr: 'Download', title: 'Food Sub Categories', className: 'tips btn btn-sm btn-white' }
			]
		},
        columns: [
