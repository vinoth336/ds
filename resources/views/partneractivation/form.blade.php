...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'partneractivation/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> partneractivation</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('first_name', $row['first_name'],array('class'=>'form-control', 'placeholder'=>'', readonly  )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('last_name', $row['last_name'],array('class'=>'form-control', 'placeholder'=>'',readonly   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group hidethis " style="display:none;">
									<label for="Avatar" class=" control-label col-md-4 text-left"> {!! trans('core.abs_last_name') !!} </label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Created At" class=" control-label col-md-4 text-left"> {!! trans('core.abs_last_login') !!} </label>
									<div class="col-md-6">
									  
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('created_at', $row['created_at'],array('class'=>'form-control', 'style'=>'width:150px !important;', readonly)) !!}
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('phone_number', $row['phone_number'],array('class'=>'form-control', 'placeholder'=>'', readonly  )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('address', $row['address'],array('class'=>'form-control', 'placeholder'=>'', readonly  )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-6">
									  {!! Form::text('state', $row['state'],array('class'=>'form-control', 'placeholder'=>'', readonly  )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group hidethis " style="display:none;">
									...
									<div class="col-md-6">
									  {!! Form::text('zip_code', $row['zip_code'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									<label for="Country" class=" control-label col-md-4 text-left"> {!! trans('core.abs_country') !!} </label>
									<div class="col-md-6">
								  ...
								  <div class="form-group hidethis " style="display:none;">
									<label for="Mobile Token" class=" control-label col-md-4 text-left"> {!! trans('core.abs_mobile_token') !!} </label>
									<div class="col-md-6">
					...
					$active_opt = array( '0' => 'Deactive' ,  '1' => 'Active' , ); ?>
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('partneractivation?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
