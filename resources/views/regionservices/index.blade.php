...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
	    <div class="toolbar-line ">
			@if($access['is_add'] ==1)
	   		<a href="{{ URL::to('regionservices/update') }}" class="tips btn btn-sm btn-white"  title="{!! Lang::get('core.btn_create') !!}">
			...
			@endif 
			<!--<a href="{{ URL::to( 'regionservices/search') }}" class="btn btn-sm btn-white" onclick="AbserveModal(this.href,'Advance Search'); return false;" ><i class="fa fa-search"></i> Search</a>				
			@if($access['is_excel'] ==1)
			<a href="{{ URL::to('regionservices/download?return='.$return) }}" class="tips btn btn-sm btn-white" title="{!! Lang::get('core.btn_download') !!}">
	 ...
	 {!! Form::open(array('url'=>'regionservices/delete/', 'class'=>'form-horizontal' ,'id' =>'AbserveTable' )) !!}
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#AbserveTable').attr('action','{{ URL::to("regionservices/multisearch")}}');
		$('#AbserveTable').submit();
	});
	...
	$('.datatable').DataTable({
        ...
        ajax: '{{ URL::to("regionservices/regionservices")}}',
		dom: 'Blfrtip',
    	buttons: {
			buttons: [
