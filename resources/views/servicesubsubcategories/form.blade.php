  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('servicesubsubcategories?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'servicesubsubcategories/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> Service SubNode Categories</legend>
								  ...
								  <div class="form-group  " >
									<label for="Main Category" class=" control-label col-md-4 text-left"> Sub Category <span class="asterix"> * </span></label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Sub Category" class=" control-label col-md-4 text-left"> Sub Node Category <span class="asterix"> * </span></label>
									<div class="col-md-6">
				         ...
				         required  >{{ $row['description'] }}</textarea> 
								  ...
								  <div class="form-group hidethis " style="display:none;">
									...
									<div class="col-md-6">
                                      ...
                                      <input type="text" name="level" class="form-control placeholder" value="2"  />
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " >
									<label for="Buffer Time" class=" control-label col-md-4 text-left"> Buffer Time <span class="asterix"> * </span></label>
									<div class="col-md-6">
									  
					<?php $buffer_time = explode(',',$row['buffer_time']);
					$buffer_time_opt = array( '0' => '0 Hour' ,  '1' => '1 Hour' ,  '2' => '2 Hours' ,  '3' => '3 Hours' ,  '4' => '4 Hours' ,  '5' => '5 Hours' , ); ?>
					<select name='buffer_time' rows='5' required  class='select2 '  > 
						<?php 
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('servicesubsubcategories?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
