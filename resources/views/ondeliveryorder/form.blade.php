  ...
  <div class="page-content row">
    ...
    <div class="page-header">
      ...
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('ondeliveryorder?return='.$return) }}">{{ $pageTitle }}</a></li>
...
<div class="sbox animated fadeInRight">
	...
	<div class="sbox-content"> 	
		 ...
		 {!! Form::open(array('url'=>'ondeliveryorder/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
<div class="col-md-12">
						<fieldset><legend> ondeliveryorder</legend>
								  ...
								  <div class="form-group  " >
									<label for="Order Id" class=" control-label col-md-4 text-left"> {!! trans('core.abs_order_id') !!} </label>
									<div class="col-md-6">
				           ...
				           >{{ $row['order_details'] }}</textarea> 
								  ...
								  <div class="form-group  " >
									<label for="Action" class=" control-label col-md-4 text-left"> {!! trans('core.btn_action') !!} </label>
									<div class="col-md-6">
									  
				<div class="input-group m-b" style="width:150px !important;">
					{!! Form::text('action', $row['action'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) !!}
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('ondeliveryorder?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {!! Lang::get('core.sb_cancel') !!} </button>
					</div>	  
